        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body smart">
                    ...
                    <h4 class="card-title">Indicator Registration Edit</h4>
                    <hr>
                    <p class="card-description"></p>
                    <form class="forms-sample" method="post" action="{{url('module-2/indicator-registration/'.$id.'/edit/')}}">
                        @csrf
                                        ...
                                        @foreach($p->indicatorRegMilestone as $i)
                                            <tr>
                                                <td>
                                                    ...
                                                    <input class="mile_year_field_" type="hidden" id="mile_year_field_" value="{{$i->milestone_year }}" name="milestone_year_{{$p->programs[0]->id}}[]" autocomplete="off">
                                                </td>
                                                <td><input type="text" class="form-control-mile milestone_planned" autocomplete="off" value="{{ $i->milestone_planned }}" name="milestone_planned_{{$p->programs[0]->id}}[]" onclick="OpenInputDialog(this, 'number', 'Planned')"  onkeyup="calculateMilestoneTotalTarget(this, 'milestone_formula_', '.milestone_planned', '#milestone_total_target')"></td>
                                                <td><input type="text" class="form-control-mile milestone_disagg_female" autocomplete="off"  value="{{ $i->milestone_female_disaggregation }}" onclick="OpenInputDialog(this, 'number', 'Disagg: Female')" name="milestone_disagg_female_{{$p->programs[0]->id}}[]" onkeyup="calculateMilestoneTotalTarget(this, 'milestone_formula_', '.milestone_disagg_female', '#milestone_disagg_female_total_target')"> </td>
                                                <td><input type="text" class="form-control-mile milestone_disagg_disability" autocomplete="off"  value="{{ $i->milestone_disability_disaggregation }}" onclick="OpenInputDialog(this, 'number', 'Disagg: Disability')" name="milestone_disagg_disability_{{$p->programs[0]->id}}[]" onkeyup="calculateMilestoneTotalTarget(this, 'milestone_formula_', '.milestone_disagg_disability', '#milestone_disagg_disability_total_target')"></td>
                                                <td><input type="text" class="form-control-mile milestone_disagg_reach_heard" autocomplete="off" value="{{ $i->milestone_hard_disability }}" onclick="OpenInputDialog(this, 'number', 'Disagg: Hard to Reach')" name="milestone_disagg_reach_heard_{{$p->programs[0]->id}}[]"  onkeyup="calculateMilestoneTotalTarget(this, 'milestone_formula_', '.milestone_disagg_reach_heard', '#milestone_disagg_reach_heard_total_target')"></td>
