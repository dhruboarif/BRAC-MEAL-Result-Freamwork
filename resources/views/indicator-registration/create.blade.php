                ...
                <div class="card-body smart">
                    ...
                    <form class="forms-sample" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPillar">Pillar Name <span style="color:#e12f2f; font-weight: 700">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="exampleIndicator2">Indicator Type <span style="color:#e12f2f; font-weight: 700">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputiIndicator-Number">Indicator Number <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            <input type="text" required class="form-control" id="exampleIndicator-number" autocomplete="off" placeholder="Indicator Number" name="indicator_number">
                            @if ($errors->has('indicator_number'))<div class="error">{{ $errors->first('indicator_number') }}</div>@endif
                        </div>
                        <div class="form-group">
                            <label for="exampleiiIndicator-Statement">Indicator Statement <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            <input type="text" required class="form-control" id="exampleIIndicator-Statement" autocomplete="off" placeholder="Indicator Statement" name="indicator_statement">
                        </div>
                        <div class="form-group">
                            <label for="exampleiiIndicator-Unit">Unit of Indicator <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            <input type="text" required class="form-control" id="exampleIIndicator-Unit" autocomplete="off" placeholder="Unit of Indicator" name="indicator_unit">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputOwner">SPA Partners <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            <div style="margin-bottom:3%" class="row">
                                @foreach($owners as $w)
                                    <div class="col-md-2">
                                        <div class="form-check" style="margin: 5px 0px 0 12px">
                                            <label class="form-check-label">
                                                <input type="checkbox" value="{{$w->id}}" id="checkbox_one" name="owner[]" data-trigger="hidden_fields_{{$w->id}}" class="trigger">
                                                {{$w->name}}</label>
                                        </div>
                                        <div id="hidden_fields_{{$w->id}}" class="hidden">
                                            <input type="text" class="form-control" id="hidden_one" name="owner_value[]">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="form-group">
                            <label for="exampleTextarea1">Definition <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            <textarea class="form-control" required id="definition" rows="5" placeholder="Type your text here" name="definition"></textarea>
                        </div>
                        <div class="form-group">
                                        ...
                                        <select required class="form-control" id="goal_target" name="goal_target" onchange="showIndicators()">
                                            ...
                                            @foreach($goals as $g)
                                                @foreach($g->sdgTargets as $gt)
                                                    <option class="goal-{{$g->id}} goal_target_hide" value="{{$gt->id}}" style="display: none">{{$gt->name}}</option>
                                                @endforeach
                                            @endforeach
                                        </select>
                                    </div>
                                            ...
                                            @foreach($goals as $g)
                                                @foreach($g->sdgTargets as $gt)
                                                    @foreach($gt->sdgIndicators as $gi)
                                                        <option class="goal-target-{{$gt->id}} goal_indicator_hide" value="{{$gi->id}}" style="display: none">{{$gi->statement}} ({{$gi->number}})</option>
                                                    @endforeach
                                                @endforeach
                                            @endforeach
                                        </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputType">Select Planned  <span style="color:#e12f2f; font-weight: 700">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <label for="exampleyear" >Year of Baseline <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <label for="exampleresult">Result <span style="color:#e12f2f; font-weight: 700">*</span></label>
                                        <input required type="text" class="form-control" id="baseline_result" autocomplete="off" placeholder="Result" name="baseline_result">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleSource">Source <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            <input required type="text" class="form-control" id="baseline_source" autocomplete="off" placeholder="Source" name="baseline_source">
                        </div>
                        <div class="form-group">
                            <label for="exampleMethode">Methodology <span style="color:#e12f2f; font-weight: 700">*</span></label>
                            <input required type="text" class="form-control" id="baseline_methodology" autocomplete="off" placeholder="Methodology" name="baseline_methodology">
                        </div>
                        <p class="card-hed">Contributions from Various BRAC Programs</p>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label for="exampleInputGool">Program <span style="color:#e12f2f; font-weight: 700">*</span></label>
                                <select required style="width:100%" class="form-control js-example-basic-multiple" multiple="" id="contributions_program" name="contributions_program[]" onchange="changePrograms()">
                        ...
                        <label class="sp" for="accordion" style="display:none;">
                            <span style=" padding:5px 15px; border-radius:5px; background-color: rgba(255,190,96,1.00); color: rgba(62,62,62,1.00); font-size:14px">
                                You have selected the following programs
                            </span>
                        </label>
                        <div class="sp" style="display:none; margin-bottom:2%" class="table-responsive">
                            <table class="table table-responsive-sm" style="background-color: rgba(251,251,251,1.00)">
                                <tbody id="selectedPrograms">
                                <tr><td></td></tr>
                                </tbody>
                            </table>
                        </div>
...
{{--                                        <th> Select Planned <br>  Number Type </th>--}}
                                        ...
                                        <th> Revisions latest<br> approved
                                            <select style="width:50px; border: 1px solid; background: transparent; color: #000; margin-left:0; font-size: smaller;" id="milestone_approved_year" name="milestone_approved_year">
                        ...
                        <div style="margin-bottom:3%" class="row">
                            ...
                            <div class="form-check" style="margin: 5px 0px 0 12px">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="dfr" value="Y" onclick="showUploader(this.checked, 'DF')">
                                    Detail Framework
                                </label>
                            </div>
                            <div class="form-check" style="margin: 5px 0px 0 12px">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="mep"  value="Y" onclick="showUploader(this.checked, 'MP')">
                                    M &amp;E Plan</label>
                            </div>
                            <div class="form-check" style="margin: 5px 0px 0 12px">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="mn"  value="Y" onclick="showUploader(this.checked, 'MN')">
                                    Methodology Note</label>
                            </div>
                            <div class="form-check" style="margin: 5px 0px 0 12px">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="sg" value="Y" onclick="showUploader(this.checked, 'SG')">
                                    SMART Guide</label>
                            </div>
                            <div class="form-check" style="margin: 5px 0px 0 12px">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="sr" value="Y" onclick="showUploader(this.checked, 'SR')">
                                    SDG Relevance</label>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group" id="DF" style="display: none">
                            ...
                            <div class="row">
                                ...
                                @foreach($fileTypeTitles as $ftt)
                                    <div class="form-check" style="margin: 5px 0px 0 12px">
                                        <label class="form-check-label">
                                            <input type="checkbox"  class="form-check-input" name="framework_file_type[]" value="{{$ftt}}">
                                            {{$ftt}}
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <div class="form-group" id="MP" style="display: none">
                            ...
                            <div class="row">
                                ...
                                @foreach($fileTypeTitles as $ftt)
                                    <div class="form-check" style="margin: 5px 0px 0 12px">
                                        <label class="form-check-label">
                                            <input type="checkbox"  class="form-check-input" name="me_file_type[]" value="{{$ftt}}">
                                            {{$ftt}}
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <div class="form-group" id="MN" style="display: none">
                            ...
                            <div class="row">
                                ...
                                @foreach($fileTypeTitles as $ftt)
                                    <div class="form-check" style="margin: 5px 0px 0 12px">
                                        <label class="form-check-label">
                                            <input type="checkbox"  class="form-check-input" name="methodology_note_file_type[]" value="{{$ftt}}">
                                            {{$ftt}}
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <div class="form-group" id="SG" style="display: none">
                            ...
                            <div class="row">
                                ...
                                @foreach($fileTypeTitles as $ftt)
                                    <div class="form-check" style="margin: 5px 0px 0 12px">
                                        <label class="form-check-label">
                                            <input type="checkbox"  class="form-check-input" name="smart_guide_file_type[]" value="{{$ftt}}">
                                            {{$ftt}}
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <div class="form-group" id="SR" style="display: none">
                            ...
                            <div class="row">
                                ...
                                <div class="form-check" style="margin: 5px 0px 0 12px">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="sdg_relevance_file_type[]" value="{{$ftt}}">
                                        {{$ftt}}
                                    </label>
                                </div>
                                @endforeach
...
@section('script')
    ...
    <script>
        $(".forms-sample").submit(function(e) {
            if($("input[name='dfr']").prop('checked') == true){
                var fm = $('input[name="framework_file_type[]"]:checked').length;
                console.log(fm);
                if(fm == 0){
            ...
            if($("input[name='mep']").prop('checked') == true){
                var mm = $('input[name="me_file_type[]"]:checked').length;
                if(mm == 0){
                    alert('Please Select File Type !');
                    e.preventDefault();
                }
            }
            if($("input[name='mn']").prop('checked') == true){
                var mmm = $('input[name="methodology_note_file_type[]"]:checked').length;
                if(mmm == 0){
                    alert('Please Select File Type !');
                    e.preventDefault();
                }
            ...
            if($("input[name='sg']").prop('checked') == true){
                var sg = $('input[name="smart_guide_file_type[]"]:checked').length;
                if(sg == 0){
                    alert('Please Select File Type !');
                    e.preventDefault();
                }
            ...
            if($("input[name='sr']").prop('checked') == true){
                var sr = $('input[name="sdg_relevance_file_type[]"]:checked').length;
                if(sr == 0){
                    alert('Please Select File Type !');
                    e.preventDefault();
                }
        ...
        function addTr(that) {
            ...
            var check = $('#checking').val();
            var newCheck = "" + blockId + district_field + police_station_field;
            if(check.length > 0){
                var ch =check.split(',');
                ...
                $('#checking').val(check+','+"" + blockId + district_field + police_station_field);
            }else{
                $('#checking').val("" + blockId + district_field + police_station_field);
            }
            if((district_field.length > 0) && (police_station_field.length > 0)){
                ...
                var   $trNew ='<tr style="background-color: rgba(243,243,243,1.00)">\n' +
                    ...
                    '                                        <input type="hidden" class="district_'+blockId+'" name="district_'+blockId+'[]" value="'+district_field+'">\n' +
                    '                                    </td>\n' +
                    '                                    <td>\n' +
                    '                                        <span>'+police_station_field_text+'</span>\n' +
                    '                                        <input type="hidden" class="police_station_'+blockId+'" name="police_station_'+blockId+'[]" value="'+police_station_field+'">\n' +
                    '                                    </td> \n' +
                    ...
                    try{
                        if(type == 'text'){
                            ...
                            $("#inputDialog").html('<input class="txtInput form-control" Class="txtBox" type="number">' +
                                '<small class="error dialog-num-error" style="display: none">Input only number</small>');
