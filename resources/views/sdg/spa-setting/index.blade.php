...
@section('content')
    <div class="row">
        <div class="col-lg-12 stretch-card grid-margin">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('sdg.settings.create')}}"><span class="btn-add text-white">Add ❭</span></a>

                    <h4 class="card-title">SDG Setting List</h4>
                    <hr>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($data as $key=>$d)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('sdg.settings.edit',$d->id)}}" class="text-decoration-none">
                                        ...
                                        <form id="{{$d->id}}" action="{{ route('sdg.settings.destroy', $d->id)}}" method="post" style="display: none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
