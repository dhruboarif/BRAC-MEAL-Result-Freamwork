                ...
                <div class="card-body smart">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td>Program List :</td>
                                <td>{{$studyArchive->program->name}} ({{$studyArchive->program->type}}: {{str_replace('_', ' ', $studyArchive->program->category)}})</td>
                            </tr>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks" placeholder="Remarks" rows="4">{{$studyArchive->remarks}}</textarea>
                            @if ($errors->has('remarks'))<div class="error">{{ $errors->first('remarks') }}</div>@endif

                        </div>

                        @can('isSupervisor')
                            @if($studyArchive->status == 'P')
                                <button type="submit" name='status' value="A" class="btn btn-primary cusbutton mr-2">Approve</button>
                                <button type="submit" name='status' value="R" class="btn btn-dark">Reject</button>
                            @endif
                        @endcan
                    </form>
