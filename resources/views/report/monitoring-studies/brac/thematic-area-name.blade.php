...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 stretch-card grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Thematic Area View</h4>
                    <hr>
                    <p class="card-description"></p>
                    <div class="table-responsive smart">
                        @foreach($data as $d)
                        <a href="{{route('report.monitoring-studies.brac.thematic-area-name').'?thematic='.$d->id}}">
                            <div class="thm-con">
                                <div class="thm-8"></div>
                                <h4 class="count">Count : {{$d->total_study_thematic}}</h4>
                                <p>{{$d->name}}</p>
                            </div>
                        </a>
                        @endforeach
