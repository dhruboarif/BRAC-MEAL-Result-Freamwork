        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body smart">
                    ...
                    <h4 class="card-title"> Result Entry Detail</h4>
                    <hr>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <select disabled class="form-control" id="piller" name="piller" onchange="getIndicatorTypeDetails()" style="color: #5b5046">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <select disabled style="color: #5b5046" class="form-control" id="indicator_type" name="indicator_type" onchange="getIndicatorTypeDetails()">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            ...
                                            <select disabled style="color: #5b5046" class="form-control" id="indicator_number" name="indicator_number">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            ...
                                            <select disabled style="color: #5b5046" class="form-control" id="indicator_statement" name="indicator_statement">
                                                <option value="">Select</option>
                                                @foreach($indicatorRegistrations as $pd)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <div class="col-sm-12">
                                                ...
                                                <select disabled style="color: #5b5046" class="form-control" id="program" name="program">
                                                    <option value="">Select</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <div class="col-sm-12">
                                            ...
                                            <select disabled style="color: #5b5046" class="form-control" id="baseline_year" name="baseline_year" onchange="changeBaselineYear()">
                                                <option selected="selected" value="">Select</option>
                                                @foreach($indicatorRegistrations as $pd)
                        ...
                        <table class="table table-responsive table-striped" style="margin-bottom:25px">
                            ...
                            @foreach($data->resultEntryDetails as $k=>$i)
                                <tr>
                                    ...
                                    <td><input type="text" value="{{$i->date_of_last_update}}" class="form-control-mile " name="last_update_date[]"></td>
