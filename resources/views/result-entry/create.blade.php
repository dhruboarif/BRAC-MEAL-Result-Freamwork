                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" id="indicator_number" name="indicator_number">
                                                ...
                                                @foreach($indicatorRegistrations as $pd)
                                                    <option style="display: none" class="{{$pd->pillar_id}}_{{$pd->indicator_type}} indicator_number_options" value="{{$pd->id}}"> {{$pd->indicator_number}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
{{--                                                @foreach($indicatorRegistrations as $pd)--}}
{{--                                                    <option style="display: none" class="{{$pd->pillar_id}}_{{$pd->indicator_type}} statement" value="{{$pd->id}}"> {{$pd->indicator_statement}}</option>--}}
{{--                                                @endforeach--}}
                                            </select>
                                        </div>
                                    </div>
...
{{--                                                <option selected="selected" value="">Select</option>--}}
                                                @foreach($indicatorRegistrations as $pd)
                                                    <option style="display: none" class="{{$pd->pillar_id}}_{{$pd->indicator_type}} baseline_year_options" value="{{$pd->baseline_year}}"> {{$pd->baseline_year}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <table class="table table-responsive table-striped" style="margin-bottom:25px">
                            ...
                            @for($i =4; $i>=0; $i--)
                                <tr>
                                    ...
                                    <td style="display: none"><input type="text" class="form-control-mile datepicker" name="recorded_to_date[]" autocomplete="off"></td>
                                    <td>
                                        <select  class="form-control-mile-sl" id="period_type" name="period_type[]" style="width: 100%">
                                            @if(($i > 0))
                                            <option  class="period_option_{{$i}} opt_annual" value="ANNUAL">Annual</option>
                                            <option   class="period_option_{{$i}} opt_half_yearly"  value="HALF_YEARLY">Half Yearly</option>
                                            <option   class="period_option_{{$i}} opt_quarterly"  value="QUARTERLY">Quarterly</option>
                                            @endif
                                            <option class="period_option_{{$i}} opt_monthly"  value="MONTHLY">Monthly</option>
                                        </select>
                                    </td>
                                    <td><input type="text" class="form-control-mile achieved" autocomplete="off" name="achieved[]" onclick="OpenInputDialog(this, 'number', 'Achieved')"  onkeyup="calculateData()"></td>
                                    <td><input type="text" id="txtBox" class="txtBox form-control-mile disagg_female" autocomplete="off" name="disagg_female[]"  onclick="OpenInputDialog(this, 'number', 'Disagg:Female')" onkeyup="calculateData()"></td>
                                    <td><input type="text" class="form-control-mile disagg_disability" autocomplete="off" name="disagg_disability[]" onclick="OpenInputDialog(this, 'number', 'Disagg:Disability')" onkeyup="calculateData()"></td>
                                    <td><input type="text" class="form-control-mile disagg_heard_to_reach" autocomplete="off" name="disagg_heard_to_reach[]" onclick="OpenInputDialog(this, 'number', 'Disagg:Hard to Reach ')" onkeyup="calculateData()"></td>
                                    <td><input type="text" class="form-control-mile" autocomplete="off" name="source[]"  onclick="OpenInputDialog(this, 'textarea', 'Source ')"></td>
                                    <td><input type="text" class="form-control-mile" autocomplete="off" name="methodology[]"  onclick="OpenInputDialog(this, 'textarea', 'Methodology ')"></td>
                                    <td><input type="text" class="form-control-mile datepicker" name="last_update_date[]"></td>
                                    <td><input type="text" class="form-control-mile" autocomplete="off" name="remarks[]"  onclick="OpenInputDialog(this, 'textarea', 'Remarks ')"></td>
                                </tr>
                            @endfor
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody><tr style=" border-bottom: 1px solid rgba(212,212,212,1.00)">
                                    ...
                                    <td><div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="formula" checked value="SUMMATION" onclick="calculateData()">
                                                Summation of yearly achievements <i class="input-helper"></i></label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="formula" value="CUMULATIVE" onclick="calculateData()">
                                                Latest year achievement for cumulative results <i class="input-helper"></i></label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input"  name="formula" value="AVERAGE" onclick="calculateData()">
                                ...
                                <tr style=" border-bottom: 1px solid rgba(212,212,212,1.00)">
                                    ...
                                    <td style="width:10%">
                                        <div class="ptotal" style="padding:10px 25px; display:inline-block;">
                                            <input type="text" readonly value="00" name="achievement_total" id="achievement_total" style="color:white;background: transparent; border: none; width: 100%">
                                        </div>
                                    </td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr style=" border-bottom: 1px solid rgba(212,212,212,1.00)">
                                    ...
                                    <td>
                                        <div class="ptotal" style="padding:10px 25px; display:inline-block;">
                                            <input type="text" readonly value="00" name="disagg_female_total" id="disagg_female_total" style="color:white;background: transparent; border: none; width: 100%">
                                        </div>
                                    </td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr style=" border-bottom: 1px solid rgba(212,212,212,1.00)">
                                    ...
                                    <td>
                                        <div class="ptotal" style="padding:10px 25px; display:inline-block;">
                                            <input type="text" readonly value="00" name="disagg_disability_total" id="disagg_disability_total" style="color:white;background: transparent; border: none; width:100%">
                                        </div>
                                    </td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr style=" border-bottom: 1px solid rgba(212,212,212,1.00)">
                                    ...
                                    <td style="width:10%">
                                        <div class="ptotal" style="padding:10px 25px; display:inline-block;">
                                            <input type="text" readonly value="00" name="disagg_heard_to_reach_total" id="disagg_heard_to_reach_total" style="color:white;background: transparent; border: none; width: 100%">
                                        </div>
                                    </td>
                                    <td></td>
                                    <td></td>
