...
@section('content')
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <a href="{{url('/document-type')}}"><span class="hed-btn">List ❭</span></a>
                    ...
                    <form class="forms-sample" method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('name') }}" class="form-control" id="name" name="name" autocomplete="off" placeholder="Document Type Name">
