        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body smart">
                    ...
                    <h4 class="card-title">SDG Setting</h4>
                                ...
                                @foreach($dataIndicator as $indicator)
                                    <tr style="background-color: rgba(243,243,243,1.00)">
                                        <td>
                                            ...
                                            <input type="hidden" name="statement[]" value="{{$indicator->statement}}">

                                        </td>
                                        <td>
                                            <span>{{$indicator->number}}</span>
                                            <input type="hidden" name="number[]" value="{{$indicator->number}}">
                                        </td>
                                        <td>
                                            <span>{{$indicator->target}}</span>
                                            <input type="hidden" name="target[]" value="{{$indicator->target}}">
                                        </td>
                                        <td width="100" align="center"><div class="minus btnRemove"  onclick="removeTr(this, {{$indicator->id}})"></div></td>
                                    </tr>
